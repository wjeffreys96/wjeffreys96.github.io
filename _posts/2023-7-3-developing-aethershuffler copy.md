...
```
Except I've removed about 2000 lines of data from the array. The Scryfall API provides tons of data on each card. Way more than we need. So I reduce 